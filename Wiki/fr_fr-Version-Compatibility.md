# 📋 Matrice de compatibilité des versions et des outils
...
## 🏛️ La politique « 1 Jar 1 Version »

**Creative Fly Speed** adhère strictement à la politique **1 Jar 1 Version** :
- **Zéro JAR universel hybride** : chaque version cible de Minecraft est développée et compilée sous forme de sous-projet indépendant.
- **Sous-projets dédiés** :
  - `Creative Fly Speed/` (ancre Minecraft 26.2)
  - `Creative Fly Speed v26.3/Creative Fly Speed 26.3/` (ancre Minecraft 26.3)
- **Exception pour la bibliothèque universelle** : le seul module multi-version est `DasikLibrary`.
