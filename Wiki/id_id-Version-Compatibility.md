...
## 🏛️ Kebijakan "1 Jar 1 Versi"

**Creative Fly Speed** mematuhi **Kebijakan 1 Jar 1 Versi** secara ketat:
- **Nol JAR Universal Frankenstein**: Alih-alih refleksi berisiko, setiap rilis Minecraft dikembangkan sebagai subproyek independen.
- **Subproyek Khusus**:
  - `Creative Fly Speed/` (jangkar Minecraft 26.2)
  - `Creative Fly Speed v26.3/Creative Fly Speed 26.3/` (jangkar Minecraft 26.3)
- **Pengecualian Perpustakaan Universal**: Satu-satunya modul multi-versi adalah `DasikLibrary`.
