...
| :--- | :--- | :--- | :---: | :--- |
| **Minecraft 26.3** | `1.0.0+26.3` | Fabric Loader `>=0.19.3` / Java 25 | 🟢 当前主版本 | [[👉 进入 MC 26.3 维基|zh_cn-26.3-Home]] |
| **Minecraft 26.2** | `1.0.0+26.2` | Fabric Loader `>=0.16.10` / Java 25 | 🟡 对齐版本 | [[👉 进入 MC 26.2 维基|zh_cn-26.2-Home]] |
...
- **[[飞行速度动力学|zh_cn-26.3-Flight-Speed-Kinematics]]**：
...
- [[版本兼容性矩阵|zh_cn-Version-Compatibility]]：Loom、Fabric Loader、Parchment 映射以及 Java 25 规范。
- [[故障排除与常见问题解答 (FAQ)|zh_cn-Troubleshooting-and-FAQ]]：解决漂移、抖动、网络包同步与多世界保存问题。
- [[开发者环境配置与构建指南|zh_cn-Developer-Setup-and-Building]]：Gradle 9.3+ 独立编译步骤与配置。
