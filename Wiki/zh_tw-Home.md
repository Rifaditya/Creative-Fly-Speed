...
| :--- | :--- | :--- | :---: | :--- |
| **Minecraft 26.3** | `1.0.0+26.3` | Fabric Loader `>=0.19.3` / Java 25 | 🟢 當前主版本 | [[👉 進入 MC 26.3 維基|26.3-Home]] |
| **Minecraft 26.2** | `1.0.0+26.2` | Fabric Loader `>=0.16.10` / Java 25 | 🟡 對齊版本 | [[👉 進入 MC 26.2 維基|26.2-Home]] |
...
- **[[飛行速度動力學|26.3-Flight-Speed-Kinematics]]**：
...
- [[版本相容性矩陣|Version-Compatibility]]：Loom、Fabric Loader、Parchment 映射以及 Java 25 規範。
- [[疑難排解與常見問題解答 (FAQ)|Troubleshooting-and-FAQ]]：解決漂移、抖動、網路封包同步與多世界保存問題。
- [[開發者環境配置與建置指南|Developer-Setup-and-Building]]：Gradle 9.3+ 獨立編譯步驟與配置。
