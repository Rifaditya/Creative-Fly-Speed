# 📋 Совместимость версий и матрица инструментов
...
## 🏛️ Политика «1 Jar — 1 версия»

**Creative Fly Speed** строго следует политике **1 Jar 1 Version**:
- **Никаких гибридных универсальных JAR**: вместо небезопасной рантайм-рефлексии каждый релизный якорь разрабатывается и компилируется как независимый подпроект.
- **Выделенные подпроекты**:
  - `Creative Fly Speed/` (якорь Minecraft 26.2)
  - `Creative Fly Speed v26.3/Creative Fly Speed 26.3/` (якорь Minecraft 26.3)
- **Исключение для библиотек**: единственным модулем, охватывающим несколько версий, является `DasikLibrary`.
