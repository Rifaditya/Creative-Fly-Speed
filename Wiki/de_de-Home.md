...
| :--- | :--- | :--- | :---: | :--- |
| **Minecraft 26.3** | `1.0.0+26.3` | Fabric Loader `>=0.19.3` / Java 25 | 🟢 Aktuell | [[👉 Zum MC 26.3 Wiki|26.3-Home]] |
| **Minecraft 26.2** | `1.0.0+26.2` | Fabric Loader `>=0.16.10` / Java 25 | 🟡 Parität | [[👉 Zum MC 26.2 Wiki|26.2-Home]] |
...
- **[[Fluggeschwindigkeits-Kinematik|26.3-Flight-Speed-Kinematics]]**:
...
- **[[Konfiguration & Regeln|26.3-Configuration-and-GameRules]]**:
...
- **[[Architektur & Mixins|26.3-Architecture-and-Mixins]]**:
...
- [[Versionskompatibilitäts-Matrix|Version-Compatibility]]: Toolchain, Fabric Loader und Java 25.
- [[Fehlerbehebung & FAQ|Troubleshooting-and-FAQ]]: Häufig gestellte Fragen, Drift-Diagnose und Speicherung.
- [[Entwickler-Setup & Bauanleitung|Developer-Setup-and-Building]]: Kompilieren mit Gradle 9.3+.
