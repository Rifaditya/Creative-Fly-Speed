# 📋 Matriz de compatibilidad de versiones y herramientas
...
## 🏛️ Política "1 Jar 1 Versión"

**Creative Fly Speed** se adhiere estrictamente a la **Política 1 Jar 1 Versión**:
- **Cero JARs universales híbridos**: cada versión de Minecraft se desarrolla y compila como un subproyecto determinista independiente.
- **Subproyectos dedicados**:
  - `Creative Fly Speed/` (ancla Minecraft 26.2)
  - `Creative Fly Speed v26.3/Creative Fly Speed 26.3/` (ancla Minecraft 26.3)
- **Excepción de biblioteca universal**: El único módulo que abarca múltiples versiones es `DasikLibrary`.
