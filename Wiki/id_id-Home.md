...
| :--- | :--- | :--- | :---: | :--- |
| **Minecraft 26.3** | `1.0.0+26.3` | Fabric Loader `>=0.19.3` / Java 25 | 🟢 Versi Utama Aktif | [[👉 Masuk ke Wiki MC 26.3|id_id-26.3-Home]] |
| **Minecraft 26.2** | `1.0.0+26.2` | Fabric Loader `>=0.16.10` / Java 25 | 🟡 Versi Paritas | [[👉 Masuk ke Wiki MC 26.2|id_id-26.2-Home]] |
...
- **[[Kinematika Kecepatan Terbang|id_id-26.3-Flight-Speed-Kinematics]]**:
...
- [[Matriks Kompatibilitas Versi|id_id-Version-Compatibility]]: Persyaratan Loom, Fabric Loader, dan Java 25.
- [[Pemecahan Masalah & FAQ|id_id-Troubleshooting-and-FAQ]]: Penanganan desinkronisasi paket dan penyimpanan dunia.
- [[Panduan Kompilasi Pengembang|id_id-Developer-Setup-and-Building]]: Langkah kompilasi dengan Gradle 9.3+.
